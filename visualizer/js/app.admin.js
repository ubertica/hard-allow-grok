const STATE_URL = '/nodes-api/proxy/state.json';
const GRAPH_URL = '/nodes-api/proxy/graph.jsonl';
const HYDRATE_URL = '/nodes-api/proxy/hydrate';
const SEARCH_URL = '/nodes-api/proxy/search-index.json';
const INTERPRET_URL = '/nodes-api/api/interpret';
